...
if __name__ == '__main__':
    ...
    image_gold_fish = load_image("mini_games/cat_foots/images/gold_fish.png", -1)
    image_gold_fish = pygame.transform.scale(image_gold_fish, (200, 200))

    image_black_fish = load_image("mini_games/cat_foots/images/black_fish.png", -1)
    image_black_fish = pygame.transform.scale(image_black_fish, (200, 200))

    image_gold_foot = load_image("mini_games/cat_foots/images/white_foot.png", -1)
    image_gold_foot = pygame.transform.scale(image_gold_foot, (250, 250))
    image_gold_foot = pygame.transform.rotate(image_gold_foot, -45)

    image_black_foot = load_image("mini_games/cat_foots/images/white_foot.png", -1)
    image_black_foot = pygame.transform.scale(image_black_foot, (250, 250))
    ...
    gold_x, gold_y = (-30, 375)
    black_x, black_y = (380, -25)
    now_x, now_y = (260, 260)

    gold_xx, gold_yy = (170, 175)
    black_xx, black_yy = (180, 175)

    image_phone = load_image("mini_games/cat_foots/images/wood.jpg", -1)
    image_phone = pygame.transform.scale(image_phone, (700, 700))
    ...
    while running:
        ...
        text_gold_rect = text_gold.get_rect(center=(125, 400))
        screen.blit(text_gold, text_gold_rect)

        text_black = font.render(f"Счёт: {cnt_black}", True, (0, 0, 0))
        text_black_rect = text_black.get_rect(center=(575, 310))
